...
class Block(nn.Module):
    ...
    def forward(self, x, attn_output=False):
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        print("Number of parameters in the model: %.2fM" % (self.get_num_params() / 1e6))
    ...
    def forward(self, idx, targets=None, attn_output=False):
        b, t = idx.size()
        ...
        if attn_output:
            ...
            for layer in self.blocks:
                x, attn = layer(x, attn_output=True)
